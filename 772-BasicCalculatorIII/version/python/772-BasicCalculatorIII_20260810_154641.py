# Last updated: 8/10/2026, 3:46:41 PM
# Calculator Design: stack
1"""
2Go through the string:
3meet the digits, transfer to the num:
...
13 ch == ")" ==> return sum(stack), transfer the string in prenthese to a num, which is same as digit num
14 """
15class Solution:
